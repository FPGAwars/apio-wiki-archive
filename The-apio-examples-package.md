...
![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-01.png)

## 2. Select the board folder

Once the repo is cloned, enter into the apio-examples folder

![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-02.png)
...
![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-03.png)

## 4. Files in the example folder

Inside the **example folder** there should be at least **four files**:

![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-04.png)
...
![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-05.png)

Then press the new release button. You will get something like this:

![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-06.png)

## 2. Download the Source .zip file

Click on the source code (zip) link for downloading the packages

![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-07.png)

You should get the file **apio-examples-x.y.z.zip** in your download folder

![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-08.png)
...
![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-09.png)
...
![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-10.png)
...
![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-11.png)

Once installed, you can check it with the **apio examples -l**. It should display the new package verion:

![](https://github.com/FPGAwars/Apio-wiki/raw/develop/wiki/Adding-examples/apio-examples-pkg-12.png)
